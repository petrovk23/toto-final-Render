files = ['Procfile', 'fly.toml', 'Dockerfile', '.dockerignore', 'id_fly_mykey', 'id_fly_mykey-cert', 'static/css/custom.css', 'static/js/main.js', 'templates/game_options.html', 'templates/combos.html', 'templates/index.html', 'templates/layout.html', 'templates/layout_no_sidebar.html', 'templates/results.html', 'analysis.py', 'app.py', 'database.py', 'init_database.py', 'config.py', 'requirements.txt']
